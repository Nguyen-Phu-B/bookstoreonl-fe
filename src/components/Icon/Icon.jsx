...
const Icon = ({ name, width = "3.2rem", height = "3.2rem", className }) => {
    const classes = cx(className);

    switch (name) {
        case "mess":
            return (
                <svg className={classes} width={width} height={height} viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
        ...
        case "upload":
            return (
                <svg className={classes} width={width} height={height} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
